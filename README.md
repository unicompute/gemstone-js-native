...
The addon validates byte ranges and session ids before dispatching into GCI so
bad JavaScript inputs fail at the boundary.
...
`index.d.ts` expose the same public helpers, and fails if the generated platform
