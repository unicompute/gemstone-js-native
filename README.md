...
or whitespace-bearing entries, non-file targets, duplicate entries, manifest
artifact targets, and that writing checksums fails when no artifact suffixes
match or when suffix filters or matching artifact names are malformed,
pathful, whitespace-bearing, or duplicated. The writer also excludes
